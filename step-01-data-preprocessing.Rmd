...
```{r, echo = FALSE}
#Code adapted from: https://stackoverflow.com/questions/37086048/change-colour-of-specific-histogram-bins-in-r/37086294
range <- c(0, 100, 150, 200, 2000)
col <- findInterval( h1$breaks, range, all.inside = TRUE)

# Colors from: https://colorbrewer2.org/#type=qualitative&scheme=Paired&n=3

col[which(col==1)] <- "#7570B3"
col[which(col==2)] <- "#1B9E77"
col[which(col==3)] <- "#D95F02"
col[which(col==4)] <- "#7570B3"

h1.alt <- hist( myNgram3miss.df$frequency , ylim = c(0, 100), col = col, main = "Histogram of 3grams, with color"  )
text(h1.alt$mids,h1.alt$counts,labels=h1.alt$counts, adj=c(0.5, -0.5))
```
...
```{r, echo = FALSE}
#Code adapted from: https://stackoverflow.com/questions/37086048/change-colour-of-specific-histogram-bins-in-r/37086294
range <- c(0, 400, 600, 800, 5200)
col <- findInterval( h2$breaks, range, all.inside = TRUE)
...
h2.alt <- hist( myNgram2miss.df$frequency , ylim = c(0, 100), col = col, main = "Histogram of 2grams, with color"  )
text(h2.alt$mids,h2.alt$counts,labels=h2.alt$counts, adj=c(0.5, -0.5))
```
